...
- (void)layoutButtonWithEdgeInsetsStyle:(ButtonEdgeInsetsStyle)style imageTitlespace:(CGFloat)space {
    ...
    switch (style) {
            ...
            case ButtonEdgeInsetsStyleImageTop:
        {
            ...
            CGFloat buttonHeight = CGRectGetHeight(self.frame);
            CGFloat boundsCentery = (imageHeight + space + labelHeight) * 0.5;
            CGFloat labelX = CGRectGetMinX(self.titleLabel.frame);
            CGFloat labelY = CGRectGetMaxX(self.titleLabel.frame);
...
//            titleInsetsLeft = centerX_button - centerX_titleLabel;
            titleInsetsLeft = -labelX;

            titleInsetsRight = -(buttonWidth - labelY);
            titleInsetsBottom = - titleInsetsTop;
        }
            break;
